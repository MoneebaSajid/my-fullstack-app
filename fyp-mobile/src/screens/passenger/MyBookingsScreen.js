  ...
  const renderBookingWithDriver = ({ item }) => (
    <View style={styles.card}>
      ...
      <View style={styles.cardFooter}>
        ...
        {/* Completed — Feedback + Check Refund */}
      ...
      {/* Track Driver — confirmed/started only */}
          ...
          <View style={styles.completedBtns}>
            ...
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('RefundStatus', {
                ...
                booking_type:    'without-driver',
                vehicle_model:   item.model,
                pickup_location: item.self_pickup_location,
              })}
            >
              <Text style={styles.refundBtnTxt}>💰 Refund</Text>
            </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  tagline:       { fontSize: 13, color: COLORS.textMuted, marginTop: 4, textTransform: 'uppercase', letterSpacing: 1.5 },
  tabContainer:  { flexDirection: 'row', backgroundColor: COLORS.inputBg, marginHorizontal: 24, borderRadius: 14, padding: 5, borderWidth: 1, borderColor: COLORS.glassBorder, marginBottom: 15 },
  ...
  card:          { backgroundColor: COLORS.glass, borderRadius: 20, padding: 20, marginBottom: 16, borderWidth: 1, borderColor: COLORS.glassBorder },
  cardHeader:    { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  vehicleName:   { fontSize: 18, fontWeight: '700', color: COLORS.white },
  ...
  divider:       { height: 1, backgroundColor: COLORS.glassBorder, marginBottom: 15 },
  infoRow:       { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8 },
  infoLabel:     { fontSize: 13, color: COLORS.textMuted },
  infoValue:     { fontSize: 13, color: COLORS.white, fontWeight: '500', maxWidth: '60%' },
  dateContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.04)', padding: 10, borderRadius: 10, marginTop: 10, justifyContent: 'center' },
  dateTxt:       { color: COLORS.light, fontSize: 12, fontWeight: '600' },
  dateArrow:     { color: COLORS.textMuted },
  cardFooter:    { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 15, paddingTop: 15, borderTopWidth: 1, borderTopColor: COLORS.glassBorder },
  amountLabel:   { fontSize: 11, color: COLORS.textMuted },
  amount:        { fontSize: 18, fontWeight: '800', color: COLORS.green },
  actionBtn:     { backgroundColor: COLORS.accent, paddingHorizontal: 14, paddingVertical: 8, borderRadius: 10 },
  actionTxt:     { color: COLORS.white, fontWeight: '700', fontSize: 12 },

  // ── Completed buttons row ──
  completedBtns: { flexDirection: 'row', gap: 8, alignItems: 'center' },
  ...
  refundBtnTxt:  { color: COLORS.green, fontWeight: '700', fontSize: 12 },

  // ── Track button ──
  trackBtn:      { backgroundColor: 'rgba(46,134,222,0.15)', borderWidth: 1, borderColor: COLORS.accent, padding: 10, borderRadius: 8, alignItems: 'center', marginTop: 8 },
  trackBtnTxt:   { color: COLORS.light, fontWeight: 'bold', fontSize: 13 },
